  ...
  <div class="education-section" style="margin-top: 2rem; padding: 2rem; background-color: #f9f9f9; border-radius: 8px; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1);">
    ...
    <ul style="list-style: disc; padding-left: 1.5rem; max-width: 800px; margin: 0 auto; text-align: left; color: #555;">
      ...
      <li style="font-size: 1.1rem; line-height: 1.8; margin-bottom: 0.8rem;">
        ...
        <a href="https://mteoriaeconomica.itam.mx/en/conoce-el-posgrado-teoriaeconomica" target="_blank">Instituto Tecnológico Autónomo de México (ITAM)</a> (2018-2020)
      </li>
      <li style="font-size: 1.1rem; line-height: 1.8; margin-bottom: 0.8rem;">
        <strong>B.Sc. in Applied Mathematics:</strong> 
        <a href="https://departamentodematematicas.itam.mx/" target="_blank">Instituto Tecnológico Autónomo de México (ITAM)</a> (2014-2018)
      </li>
    </ul>
  </div>
